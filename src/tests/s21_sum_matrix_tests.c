 ...
 * Edit the original source file "s21_sum_matrix_tests.tc" instead.
 */

#include "s21_matrix_tests.h"
START_TEST(s21_sum_0) {
  ...
  matrix_t M_res = {0};
  int res = s21_sum_matrix(&M1, &M2, &M_res);
...
START_TEST(s21_sum_11) {
  ck_assert_int_eq(s21_sum_matrix(NULL, NULL, NULL), S21_ERROR);
}
END_TEST

START_TEST(s21_sum_12) {
  INV_MATRIX
  matrix_t M1_result = {0};
  ck_assert_int_eq(s21_sum_matrix(&inv_matrix, &inv_matrix, &M1_result),
                   S21_ERROR);
}
END_TEST

Suite *s21_sum_matrix_tests(void) {
  Suite *s1 = suite_create(PRE_TEST_HEADER "S21_SUM" POST_TEST_HEADER);
  TCase *tc1_1 = tcase_create("S21_SUM");

  suite_add_tcase(s1, tc1_1);
  tcase_add_test(tc1_1, s21_sum_0);
  tcase_add_test(tc1_1, s21_sum_1);
  tcase_add_test(tc1_1, s21_sum_2);
  tcase_add_test(tc1_1, s21_sum_3);
  tcase_add_test(tc1_1, s21_sum_4);
  tcase_add_test(tc1_1, s21_sum_5);
  tcase_add_test(tc1_1, s21_sum_6);
  tcase_add_test(tc1_1, s21_sum_7);
  tcase_add_test(tc1_1, s21_sum_8);
  tcase_add_test(tc1_1, s21_sum_9);
  tcase_add_test(tc1_1, s21_sum_10);
  tcase_add_test(tc1_1, s21_sum_11);
  tcase_add_test(tc1_1, s21_sum_12);
